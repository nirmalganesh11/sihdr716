        ...
        <div className = "product-content">
         ...
         {/* <div className = "product-price">
          ...
          <div className = "product-detail">
            ...
            <h1>Full Form</h1>
            <p>{product.fullForm}</p>

            <h1>Minimum Percentage</h1>
            <p>{product.minimumPercentage}</p>

            <h1>Average Fees</h1>
            <p>{product.AvgFees}</p>
              
            <h1>Employement Roles</h1>
            <p>{product.EmploymentRoles}</p>

            <h1>Average Salary Offered</h1>
            <p>{product.AverageSalaryOffered}</p>

            <h1>About</h1>
            <p>{product.about}</p>
            
            <h1>Syllabus</h1>
            <p>{product.syllabus}</p>

            <h1>Career Options</h1>
            <p>{product.CareerOptions}</p>
           ...
           <div>
           <ul>
             <li>Courses</li> <Select  className='select-product' placeholder="Choose an option">

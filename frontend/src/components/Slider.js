...
const Slider = () => {
     const SliderData = [
        ...
        {
            title: 'Find The Best University for you',
            subtitle :'With maximum coverage'
        },
        {
 
            title: 'The Best Courses',
            subtitle :'Comfort For your long life'
        },
        {
            title: 'It is now',
        ...
        <div className = 'slider'>
            {SliderData.map((slide,index) =>{
                return(
                    ...
                    <div className = 'content'> <Link to= '/Universities'> <ShopNowBtn /></Link>  </div>
                    </div>
                );

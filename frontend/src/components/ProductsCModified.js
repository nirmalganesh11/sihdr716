...
import CourseCardProduct from './CourseCardProduct'
const ProductsCModified = ({match,history}) => {
    ...
    return (
        ...
        <div className = 'Cgfilter'>
            <h1>{Cg ? Cg : keyword ?  "*" + keyword + "* Search" : 'All'} Courses</h1>
        ...
        <div className = 'pricediv'>
            ...
            <h1 className = 'nothingfound'>Nothing Found !!!</h1> : <div className='cardsProduct'>
                       {products.map((product) =>(
                               <CourseCardProduct key={product._id} product={product} />
...
export default ProductsCModified

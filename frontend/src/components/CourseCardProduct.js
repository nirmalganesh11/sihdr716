...
const CourseCardProduct = ({product}) => {
        ...
        <> 
            <div className='cardProduct' onMouseOver={ ()=> {setShowbtn (true)}} 
               ...
               <div className='bottomcard'>
                       <Link to={`/course/${product._id}`} exact  >     
                       ...
                       <div className = 'productpricecard'> {`${product.duration} years`}</div>
...
export default CourseCardProduct
